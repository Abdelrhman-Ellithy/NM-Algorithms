...
% Reduce paragraph spacing for algorithm descriptions
...
\subsection{Pseudocode for Proposed Algorithms}
...
\bibitem{badr2021comparativepaper} Badr, E., Almotairi, S., and Ghamry, A.E. (2021). A Comparative Study among New Hybrid Root Finding Algorithms and Traditional Methods. Mathematics, 9(11), 1306.
\bibitem{sabharwal2019blendedpaper} Sabharwal, C.L. (2019). Blended Root Finding Algorithm. Mathematics, 7(11), 1118.
\bibitem{sabharwal2019hybridpaper} Sabharwal, C.L. (2019). Hybrid Algorithm Improving Bisection, Regula Falsi, Dekker, Brent Algorithms. Mathematics, 7(12), 1234.
\bibitem{sabharwal2021iterativepaper} Sabharwal, C.L. (2021). An Iterative Hybrid Algorithm for Roots of Non-Linear Equations. Mathematics, 9(5), 567.
\bibitem{sabharwal2023wavepaper} Sabharwal, C.L. (2023). A New Wave of Hybrid Algorithms. Mathematics, 11(2), 234.
\bibitem{thota2019trigonometricalpaper} Thota, V.K.S., Srivastav, S., and Kumar, M. (2019). A New Trigonometrical Algorithm for Computing Real Root of Non-Linear Transcendental Equations. International Journal of Applied and Computational Mathematics, 5(2), 60.
