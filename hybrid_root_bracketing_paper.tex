...
% --- Add figures for performance plots ---

% Average CPU time per algorithm
\begin{figure}[H]
    \centering
...
% CPU time per problem for each algorithm
\begin{figure}[H]
    \centering
...
% Overall average CPU time per algorithm
\begin{figure}[H]
    \centering
...
% Top 3 fastest algorithms per problem
\begin{figure}[H]
    \centering
